/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 35b512d959171c68a9df1d9dcf708b40)
// Runtime types generated with workerd@1.20260811.1 2026-09-13 nodejs_compat
interface __BaseEnv_Env {
	MODEL_BUCKET: R2Bucket;
	SUPABASE_URL: "https://qoixmfuxinmbtwfrhles.supabase.co";
	ALLOWED_ORIGINS: "https://elikhaweb.vercel.app,http://localhost:3000,http://127.0.0.1:3000,http://localhost:56057,http://127.0.0.1:56057,http://localhost:56058,http://127.0.0.1:56058";
	MODEL_STORAGE_CAPACITY_BYTES: "10000000000";
	MAX_MODEL_FILE_BYTES: "52428800";
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "SUPABASE_URL" | "ALLOWED_ORIGINS" | "MODEL_STORAGE_CAPACITY_BYTES" | "MAX_MODEL_FILE_BYTES">> {}
}
