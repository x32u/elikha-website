/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-file=.dev.vars.example` (hash: 99ab45818cac688111e95f4af6539a2d)
// Runtime types generated with workerd@1.20260811.1 2026-08-13 nodejs_compat
interface __BaseEnv_Env {
	EMAIL: SendEmail;
	ENVIRONMENT: "production";
	APP_BASE_URL: "https://replace-with-elikha-domain.example";
	EMAIL_FROM_ADDRESS: "notifications@replace-with-verified-domain.example";
	EMAIL_FROM_NAME: "E-Likha";
	MAX_EMAILS_PER_RUN: "20";
	SUPABASE_URL: string;
	SUPABASE_SERVICE_ROLE_KEY: string;
	MANUAL_RUN_SECRET: string;
	SUPABASE_AUTH_EMAIL_HOOK_SECRET: string;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "APP_BASE_URL" | "EMAIL_FROM_ADDRESS" | "EMAIL_FROM_NAME" | "MAX_EMAILS_PER_RUN" | "SUPABASE_URL" | "SUPABASE_SERVICE_ROLE_KEY" | "MANUAL_RUN_SECRET" | "SUPABASE_AUTH_EMAIL_HOOK_SECRET">> {}
}
